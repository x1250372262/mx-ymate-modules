!function (e, t) {
    ...
    j.prototype = {
        constructor: j, _initConfig: function () {
            ...
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#fcfdfe").css("border", "1px solid #f1f1f1"), s.css("border", "1px solid #f1f1f1").css("border-top", "none").css("height", "300px")) : (a = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l), a.addClass("w-e-toolbar"), s.addClass("w-e-text-container"), s.css("z-index", r), l.addClass("w-e-text");
