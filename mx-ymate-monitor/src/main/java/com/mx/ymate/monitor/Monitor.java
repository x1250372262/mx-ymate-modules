...
import com.mx.ymate.monitor.enums.TypeEnum;
import com.mx.ymate.monitor.helper.ProjectHelper;
...
public final class Monitor implements IModule, IMonitor {
    ...
    public void start() throws Exception {
        if (ClientEnum.isServer(config.client())) {
            switch (TypeEnum.valueTo(config.type())) {
                case SERVER:
