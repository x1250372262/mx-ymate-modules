LOGIN_VIEW = "/security/login_view.html";
var editors = {}
var version = 1
...
document.write('<link rel="stylesheet" type="text/css" href="/statics/plugins/font-awesome-4.7.0/css/font-awesome.min.css?v=' + version + '"/>');
...
document.write('<script type="text/javascript" src="/statics/js/jquery.min.js?v=' + version + '"><\/script>');
...
document.write('<script type="text/javascript" src="/statics/js/bootstrap.min.js?v=' + version + '"><\/script>');
