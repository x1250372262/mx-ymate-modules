...
class Table {
    ...
    #initDetail() {
        ...
        tableDom.on("click", ".detail", function () {
            ...
            let dom = $(this).attr("data-bs-target");
    ...
    #initDelete() {
        ...
        tableDom.on("click", ".deletes", function () {
            let id = $(this).attr("dataId");
            console.log(id)
            parent.$("#deletes").attr("dataId", id);
            openParentModal(".removeDio");
        });
            ...
            Request.builder()
                ...
                .callback(function (e) {
                    if (e.code === "00000") {
                        ...
                        setTimeout(function () {
                            tableDom.bootstrapTable('refresh');
                            parent.$(".removeDio").find(".close-btn").trigger("click");
                        }, 1000)
                    } else {
    ...
    static tableOptionDefault(value, row, index, customFuc){
        let html = ' <a class="btn btn-sm btn-default edits me-1" data-toggle="modal" data-target="#commonDiv" dataId="' + row.id + '" title="编辑" >编辑</a>' +
            '<a class="btn btn-xs btn-sm deletes" data-toggle="modal" data-target=".removeDio" dataId="' + row.id + '"  title="删除" >删除</a>';
