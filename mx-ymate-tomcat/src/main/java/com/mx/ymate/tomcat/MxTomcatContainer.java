...
import net.ymate.module.embed.tomcat.TomcatContainer;
...
/**
 * @Author: xujianpeng.
 * @Date: 2023-02-08 14:56
 * @Description:
 */
public class MxTomcatContainer {
    ...
    public static void start(String... args) throws IOException {
        ...
        final File contextPathDir = new File(tempBaseDir.toUri());
        //
        tomcat = new Tomcat();
        tomcat.setPort(port);
        tomcat.setHostname(configs.getString(CONFIG_KEY_HOST_NAME, "localhost"));
        tomcat.setBaseDir(contextPathDir.getAbsolutePath());
        //
