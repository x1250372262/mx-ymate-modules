...
#### 使用方法
- 1.创建ymp项目之后，把原来WEB-INF/cfgs目录下文件复制到resources目录中
- 2.把undertow.txt文件复制到resources目录中
- 3.新建application类，代码如下
...
# 是否微服务模式
undertow.microServiceMode=false
...
#端口 不指定的话 微服务模式下端口随机 单体模式下默认8080
undertow.port=8081
...
# 配置 ciphers，多个配置用冒号分隔，详情见：https://jfinal.com/share/2323
# undertow.ssl.ciphers = TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
# 配置 enabledProtocols，多个配置用空格分隔
# undertow.ssl.enabledProtocols = TLSv1 TLSv1.1 TLSv1.2
